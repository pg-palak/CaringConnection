...
WebUI.setText(findTestObject('Login_Pages/Sign_In_Page/input_Username'), 'Test11@gmail.com')

WebUI.setText(findTestObject('Login_Pages/Sign_In_Page/input_Password'), 'Abc1234@')
...
String Edu = WebUI.getText(findTestObject(null))
...
WebUI.verifyElementPresent(findTestObject('Thankyou_Page/Thankyou_Page_Objects/txt_h1_Thank you'), 0)
