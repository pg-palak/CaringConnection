...
System.setProperty('webdriver.chrome.driver', 'C:/Users/YuvarajV/Downloads/chromedriver1-win64/chromedriver-win64/chromedriver.exe')
...
//Enter Email
WebUI.setText(findTestObject('Login_Page/Login_Page_Objects/Input_Email'), 'demo31@gmail.com')
...
try {
    // Load the audio file
    AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File('C:/Users/YuvarajV/Downloads/danville.wav'))
...
//click on next btn
WebUI.click(findTestObject('Profile_Creation_Page/Profile_Creation_Page_Objects/button_Next'), 30)
